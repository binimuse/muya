...
class WriteCoverLetterView extends GetView<WriteCoverLetterController> {
  const WriteCoverLetterView({super.key});
          ...
          Expanded(
            child: TextField(
              ...
              decoration: InputDecoration(
                hintText:
                    'Describe the job and your experience for the cover letter...',
